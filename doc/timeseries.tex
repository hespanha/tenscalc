...
\begin{command}{tsODEzho}
\begin{lstlisting}
constraint=tsODE(x,u,d,ts,fun)
\end{lstlisting}
\end{command}

ZHO on input \lstinline{u} but no ZHO on input \lstinline{d} 

\begin{align*}
  \dot x = f(x,u,d,t)
\end{align*}

\lstinline{fun(x,u,d,t)}


\begin{command}{tsCLTIzho}
\begin{lstlisting}
constraint=tsCLTI(x,u,ts,A,B)
\end{lstlisting}
\end{command}


\begin{command}{tsDLTI}
\begin{lstlisting}
constraint=tsCLTI(x,u,ts,A,B)
\end{lstlisting}
\end{command}
