...
% along with TensCalc.  If not, see <http://www.gnu.org/licenses/>.
    ...
    declareParameter(...
        ...
        'Description',{
            ...
            'in Newton''s method line search, which makes convergence slower but often'
            'more robust.'
                      });
    ...
    declareParameter(...
        ...
        'AdmissibleValues',{false,true},...
        'Description',{
            'When |true| the affine search direction step is omitted, which'
            'makes convergence slower but more robust.'
                      });
    ...
    declareParameter(...
        ...
        'DefaultValue',100,...
        'Description',{
            'Minimum number of similar instruction that will be execute as part of a for(;;) loop,'
            'rather than being executed as independent C commands. When equal to ''inf'', instructions';
            'will never be grouped into foor loops.'
                      });
